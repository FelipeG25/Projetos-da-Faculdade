...
public class Principal {
	...
	//Operacoes() é o método construtor.
	//Os contrutores tem sempre o nome da classe.
	//Se a pessoa não define um método construtor, o java cria um pra você.
	//Se você cria um construtor, você não coloca nenhum retorno dele e nem um modificador de acesso.
